<div class="page_section" id="events-page">
    <div id="container">
        <div class="titlebox">
            ...
            <h2 class="fr"><a href="index.php?page=add-new-events" class="button2">Add New</a></h2>
        </div><!-- end .titlebox -->
        <div class="content">
			...
			<tbody>
					<tr>
						<td width="1">1</td>
						<td><a href="#">Go Girl 2014</a></td> 
						<td>
                        	<a href="#" class="button"><span class="icon-pencil">&nbsp;</span> Edit</a>
                        	<a href="#" class="button"><span class="icon-trash">&nbsp;</span> Delete</a>
                        </td>
					</tr>
					<tr>
						<td width="1">2</td>
						<td><a href="#">Never Say Maybe</a></td> 
						<td>
                        	<a href="#" class="button"><span class="icon-pencil">&nbsp;</span> Edit</a>
                        	<a href="#" class="button"><span class="icon-trash">&nbsp;</span> Delete</a>
                        </td>
